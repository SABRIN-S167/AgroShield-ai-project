...
const QUICK_PROMPTS_KEY = ["quickPrompt1", "quickPrompt2", "quickPrompt3", "quickPrompt4"] as const;
    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-display font-black text-xl">{t.chatbotTitle}</h2>
      ...
      {/* Quick Prompts */}
      <div>
        <p className="text-xs text-muted-foreground font-medium mb-2 px-1">{t.quickQuestions}</p>
