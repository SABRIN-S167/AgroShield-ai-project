...
import { getBotResponse, getGreetingMessage, type ChatMessage } from "@/lib/chatbotResponses";
...
const QUICK_PROMPTS = [
  ...
  "How do I protect rice from pests?",
  "Wind is 65 km/h, locust risk?",
  "Cotton humidity is high, advice?",
];
    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-display font-black text-xl">AI Crop Advisor</h2>
            <p className="text-white/70 text-xs">Ask anything about crops, pests, weather & risk</p>
          </div>
        </div>
      </motion.div>
      ...
      {/* Quick Prompts */}
      <div>
        <p className="text-xs text-muted-foreground font-medium mb-2 px-1">💡 Quick questions:</p>
