...
import { I18N, type I18nT } from "@/lib/i18n";
...
const navItems = (t: I18nT) => [
  ...
  { id: "crop-recommend", label: t.cropGuide, icon: Sprout },
  { id: "market", label: t.mandiPrices, icon: ShoppingCart },
  { id: "schemes", label: t.schemes, icon: IndianRupee },
  { id: "expenses", label: t.expenses, icon: BarChart3 },
