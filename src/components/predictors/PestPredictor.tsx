...
import { calculatePestRisk, saveToHistory } from "@/lib/riskEngine";
      ...
      <div className="glass-card rounded-2xl p-6 space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <Label className="font-semibold text-sm">{t.temperature}</Label>
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <Label className="font-semibold text-sm">{t.humidity}</Label>
