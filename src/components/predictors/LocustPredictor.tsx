...
import { calculateLocustRisk, saveToHistory, LABELS } from "@/lib/riskEngine";
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6 space-y-6">
        ...
        <div className="flex items-center justify-between p-4 rounded-xl bg-muted/50 border border-border">
          <div>
            <Label className="font-semibold text-sm block">Nearby Locust Activity</Label>
            <p className="text-xs text-muted-foreground mt-0.5">Confirmed locust sighting within 50km</p>
          </div>
          <Switch
